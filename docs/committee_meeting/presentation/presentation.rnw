...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{.5\linewidth}
      \begin{center}
<<echo=false,fig=true,results=hide,width=9,height=11>>=
par(col="white",mfrow=c(3,1)) 
hist(rnorm(1000),pch=1:10,bg='black',col='white',col.axis='white',col.lab='white',fg='white',xaxt='n',yaxt='n',xlab='',ylab='',xlim=c(-5,5),main='',border='lightgrey')
hist(rnorm(1000,3),pch=1:10,bg='black',col='white',col.axis='white',col.lab='white',fg='white',xaxt='n',yaxt='n',xlab='',ylab='',xlim=c(-5,5),main='',border='lightgrey')
hist(rnorm(1000,-2),pch=1:10,bg='black',col='white',col.axis='white',col.lab='white',fg='white',xaxt='n',yaxt='n',xlab='',ylab='',xlim=c(-5,5),main='',border='lightgrey')
@         
      \end{center}
    \end{column}
  \end{columns}
