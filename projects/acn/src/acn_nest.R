...
sen.gnet <- mean.g(sen.com,sen.geno)
                                        #live
liv.nest <- list()
liv.nest[[1]] <- oecosimu(liv.gnet,method='r00',nestfun=nestedtemp,nits=1000,burn=50)
liv.nest[[2]] <- oecosimu(liv.gnet,method='r0',nestfun=nestedtemp,nits=1000,burn=50)
liv.nest[[3]] <- oecosimu(liv.gnet,method='c0',nestfun=nestedtemp,nits=1000,burn=50)
liv.nest[[4]] <- oecosimu(liv.gnet,method='r1',nestfun=nestedtemp,nits=1000,burn=50)
...
write.csv(liv.nest,file='../results/nest_liv.csv')
                                        #sen
sen.nest <- list()
sen.nest[[1]] <- oecosimu(sen.gnet,method='r00',nestfun=nestedtemp,nits=1000,burn=50)
sen.nest[[2]] <- oecosimu(sen.gnet,method='r0',nestfun=nestedtemp,nits=1000,burn=50)
sen.nest[[3]] <- oecosimu(sen.gnet,method='c0',nestfun=nestedtemp,nits=1000,burn=50)
sen.nest[[4]] <- oecosimu(sen.gnet,method='r1',nestfun=nestedtemp,nits=1000,burn=50)
