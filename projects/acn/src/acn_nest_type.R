...
cgPlotweb(acn.bpn[acn.type=='sen',],geno.t[type.t=='live'])
                                        #tree level
nest.liv <- list()
nest.liv[[1]] <- oecosimu(acn.bpn[acn.type=='live',],nestfun='nestedtemp',method='r00',nsimul=1000)
nest.liv[[2]] <- oecosimu(acn.bpn[acn.type=='live',],nestfun='nestedtemp',method='r0',nsimul=1000)
nest.liv[[3]] <- oecosimu(acn.bpn[acn.type=='live',],nestfun='nestedtemp',method='c0',nsimul=1000)
nest.liv[[4]] <- oecosimu(acn.bpn[acn.type=='live',],nestfun='nestedtemp',method='r1',nsimul=1000)
nest.sen <- list()
nest.sen[[1]] <- oecosimu(acn.bpn[acn.type=='sen',],nestfun='nestedtemp',method='r00',nsimul=1000)
nest.sen[[2]] <- oecosimu(acn.bpn[acn.type=='sen',],nestfun='nestedtemp',method='r0',nsimul=1000)
nest.sen[[3]] <- oecosimu(acn.bpn[acn.type=='sen',],nestfun='nestedtemp',method='c0',nsimul=1000)
nest.sen[[4]] <- oecosimu(acn.bpn[acn.type=='sen',],nestfun='nestedtemp',method='r1',nsimul=1000)
                                        #results summary
