...
pit.l <- split(sen,paste(pit$tree[pit[,1]=='sen'],pit$geno[pit[,1]=='sen']))
########################################################################
...
dput(acn.cs,'../data/acn_cs_sen.Rdata')
dput(acn.ses,'../data/acn_ses_sen.Rdata')
dput(acn.p,'../data/acn_pval_sen.Rdata')
