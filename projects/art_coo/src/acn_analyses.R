...
arth <- read.csv('~/projects/dissertation/projects/art_coo/data/arth_cooc.csv')
redo <- read.csv('~/projects/dissertation/projects/art_coo/data/arth_cooc_PIT_redo.csv')
key <- read.csv('~/projects/dissertation/projects/art_coo/data/key.csv')
